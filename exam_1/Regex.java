...
public class Regex {
    public static void main(String[] args) {
        ...
        //my password input: @E92i7o4a

        // Provide the pattern
        pattern = Pattern.compile("(?=.*\\d)(?=.*[AaEeIiOoUu]).{8,}");
        ...
        //my email ad input: katherinemae_90@gmail.com

        // Provide regex pattern
        pattern = Pattern.compile("\\w{10,}@gmail.com");
        ...
        //my url input: www.katherineespinosa.com
